...
new Vue({
  ...
  template: `
    ...
    <!-- 标题-->
    <div class="setting-row-style"><span class="font-title">辽宁工程技术大学校大学生自律委员会抽选系统</span></div>

    <!-- 设置抽签主题 -->
    <div class="setting-row-style"><span class="font-label">请输入本次活动的主题~</span></div>
    ...
    <div class="setting-row-style">
      ...
      >
        <a-select-option :value="0">默认抽名模式</a-select-option>
        <a-select-option :value="1">自定义奖项抽签模式</a-select-option>
      </a-select>
      <a-icon
    ...
    <div class="setting-row-style">
      ...
      >
        <a-select-option :value="0">允许个人重复中奖</a-select-option>
        <a-select-option :value="1">不允许个人重复中奖</a-select-option>
      </a-select>
    </div>
      ...
      <!-- 副标题 -->
      <div class="setting-row-style"><span class="font-label">选择背景(进入后还可选择图片作为背景)</span></div>
      ...
      <div class="setting-row-style"><span class="font-label">进入系统</span></div>
        <!-- 进入抽签界面 -->
        <div class="setting-row-style">
        <a-button
          class="setting-button"
